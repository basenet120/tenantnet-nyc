...
export default async function InvalidAuthPage() {
  const { t } = await getAppStrings();

  return (
    <div className="min-h-dvh flex items-center justify-center px-5 sm:px-6">
